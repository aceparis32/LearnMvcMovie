...
var loc = {
    ...
    "facebook": "Facebook",
    "feedback": "Feedback",
    "feedbackCommunityHelp": "Community Help",
    ...
    "min.to.read": "min to read",
    "minimize": "Minimize",
    "moduleReference": "{0} Module Reference",
    "monikerFallback": "The requested page is not available for {0}. You have been redirected to a compatible version.",
    "more": "More",
    ...
    "search": "Search",
    "searchScopeAction": "Tap to remove filter.",
    "searchScopeInfo": "Search filter set to",
    ...
    "theme": "Theme",
    "token.acceptedValues": "accepted values",
    "token.additionalFeaturesAndRequirements": "Additional features and requirements",
    "token.attributes": "Attributes",
    "token.caution": "Caution",
    "token.classesInSubtitle": "Classes",
    "token.clsCompliant": "This API is not CLS-compliant.",
    "token.clsCompliantAlt": "CLS-compliant alternative",
    "token.commands": "Commands",
    "token.constructorsInSubtitle": "Constructors",
    "token.defaultValue": "default value",
    "token.definition": "Definition",
    "token.delegatesInSubtitle": "Delegates",
    "token.derived": "Derived",
    "token.description": "Description",
    "token.edit": "Edit",
    "token.eiisInSubtitle": "Explicit Interface Implementations",
    "token.enumsInSubtitle": "Enums",
    "token.eventsInSubtitle": "Events",
    "token.examples": "Examples",
    "token.exceptions": "Exceptions",
    "token.extensionMethodsInSubtitle": "Extension Methods",
    "token.fieldsInSubtitle": "Fields",
    "token.globalParameters": "Global Parameters",
    "token.implements": "Implements",
    "token.important": "Important",
    "token.in": "in",
    "token.inheritance": "Inheritance",
    "token.inheritedMembers": "Inherited Members",
    "token.interfacesInSubtitle": "Interfaces",
    "token.inThisArticle": "In This Article",
    "token.loadMore": "More&#8230;",
    "token.members": "Members",
    "token.methodsInSubtitle": "Methods",
    "token.name": "Name",
    "token.namespace": "Namespace",
    "token.namespaces": "Namespaces",
    "token.next": "Next Steps",
    "token.note": "Note",
    "token.operatorsInSubtitle": "Operators",
    "token.optionalParameters": "Optional Parameters",
    "token.overloads": "Overloads",
    "token.overrides": "Overrides",
    "token.package": "Package",
    "token.packages": "Packages",
    "token.parameters": "Parameters",
    "token.propertiesInSubtitle": "Properties",
    "token.readonly": "read only",
    "token.remarks": "Remarks",
    "token.required": "required",
    "token.requiredParameters": "Required Parameters",
    "token.returns": "Returns",
    "token.seeAlso": "See Also",
    "token.services": "Services",
    "token.showAllDerived": "Show all derived classes",
    "token.structsInSubtitle": "Structs",
    "token.threadSafety": "Thread Safety",
    "token.tip": "Tip",
    "token.tutorial_allContributors": "all {0} contributors",
    "token.tutorial_complete100": "100% Complete!",
    "token.tutorial_congratulations": "Congratulations!",
    "token.tutorial_continueHere": "Continue Here",
    "token.tutorial_contributors": "Contributors",
    "token.tutorial_furtherReading": "Further Reading",
    "token.tutorial_introduction": "Introduction",
    "token.tutorial_minRemain": "{0}min Remaining",
    "token.tutorial_minsRemaining": "{0}min Remaining",
    "token.tutorial_minutesToComplete": "{0} Minutes to Complete",
    "token.tutorial_next": "Next",
    "token.tutorial_nextSteps": "Next Steps",
    "token.tutorial_nextTutorial": "Next Tutorial",
    "token.tutorial_previous": "Previous",
    "token.tutorial_resources": "Resources",
    "token.tutorial_seeAllContributors": "See {0} or become a contributor by suggesting improvements on {1}.",
    "token.tutorial_startHere": "Start Here",
    "token.tutorial_youLearned": "You learned how to...",
    "token.tutorial_youveCompleted": "You've completed the \"{0}\" tutorial.",
    "token.tutorial_youWillLearn": "You will learn how to...",
    "token.type": "type",
    "token.typeParameters": "Type Parameters",
    "token.usage": "Usage",
    "token.value": "Value",
    "token.valueFrom": "value from",
    "token.warning": "Warning",
    "token.win10Requirements": "Windows 10 requirements",
...
var platformId = getParam('platform', 'meta') || getParam('apiPlatform', 'meta') || null;
...
function readPageMonikers() {
    var tags = document.querySelectorAll('meta[name="monikers"]');
...
var platformConfig = {
    ...
    powershell: {
        ...
        quickFilters: [
            ['powershell-5.1'], ['azurermps-4.3.1'], []
        ]
    }
};
...
function finishRenderingAsync(allApis, button, buttonCaption, productList) {
        ...
        return getPlatform().then(function (platform) {
            ...
            var updateCaption = function () {
                ...
                if (moniker === '') {
                    ...
                    buttonCaption.textContent = platform.packagesByMoniker[moniker].displayName;
                }
            };
    ...
    return getFamily().then(function (family) {
        ...
        var updateCaption = function () {
            var moniker = getMoniker();
            buttonCaption.textContent = findPackageInFamily(family, moniker).displayName;
        };
        window$1.addEventListener(monikerChangedEvent, updateCaption);
        updateCaption();
        renderProducts(family.products, productList);
...
function createSearchField() {
    ...
    labelSpan.classList.add('screenReader');
...
var useMonikerPicker = pageTemplate === 'Reference' && pageMonikers.any
...
function createForTutorial(isPowerShell) {
    ...
    screenReaderSpan.classList.add('screenReader');
...
interactiveTypes['csharp'] = {
    ...
    createForTutorial: function () {
        ...
        runButton.onclick = function () { return dotnetOnline.run(); };
...
function createQuickFilter() {
    ...
    var setVisibility = function () { return blockDiv.hidden = getMoniker() !== '' || getTerm() !== ''; };
    window$1.addEventListener(monikerChangedEvent, setVisibility);
    window$1.addEventListener(apiSearchTermChangedEvent, setVisibility);
    setVisibility();
    return blockDiv;
}
...
function apiBrowserPage() {
    ...
    if (main.querySelector('h1') === null) {
        var h1 = document$1.createElement('h1');
        h1.textContent = platformConfig[platformId].title;
        main.insertAdjacentElement('beforebegin', h1);
    }
